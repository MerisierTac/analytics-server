...
public class ExpirationTokenPresenceOAuth2TokenValidatorTest {
    ...
    public void shouldFailIfNoJtiInTheToken() {
        ...
        Assertions.assertThat(oAuth2ErrorResult.getErrorCode())
                .isEqualTo(ExpirationTokenPresenceOAuth2TokenValidator.EXPIRATION_NOT_FOUND_OAUTH2ERROR.getErrorCode());
        Assertions.assertThat(oAuth2ErrorResult.getDescription())
                .isEqualTo(
                        ExpirationTokenPresenceOAuth2TokenValidator.EXPIRATION_NOT_FOUND_OAUTH2ERROR.getDescription()
                );
