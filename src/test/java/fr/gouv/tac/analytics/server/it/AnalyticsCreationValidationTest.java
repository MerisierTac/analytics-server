...
public class AnalyticsCreationValidationTest {
    ...
    public void itShouldRejectAnalyticsWithoutInstallationUuid() throws Exception {
        ...
        checkResult(
                mvcResult,
                "[Field error in object 'analyticsRequest' on field 'installationUuid': rejected value [null]",
    ...
    public void itShouldRejectAnalyticsWithEmptyInstallationUuid() throws Exception {
        ...
        checkResult(
                mvcResult,
                "[Field error in object 'analyticsRequest' on field 'installationUuid': rejected value []",
                OffsetDateTime.now(ZoneId.of("UTC"))
        );
    }
    ...
    public void itShouldRejectAnalyticsWithEmptyEventName() throws Exception {
        ...
        checkResult(
                mvcResult, "[Field error in object 'analyticsRequest' on field 'events[0].name': rejected value []",
                OffsetDateTime.now(ZoneId.of("UTC"))
        );
    }
    ...
    public void itShouldRejectAnalyticsWithoutEventTimeStamp() throws Exception {
        ...
        checkResult(
                mvcResult,
                "[Field error in object 'analyticsRequest' on field 'events[0].timestamp': rejected value [null]",
                OffsetDateTime.now(ZoneId.of("UTC"))
        );
    }
    ...
    public void itShouldRejectAnalyticsWithBadFormattedEventTimeStamp() throws Exception {
        final String analyticsJsonWithBadFormattedEventTimeStamp = Files
                .readString(Paths.get("src/test/resources/it/analyticsJsonWithBadFormattedEventTimeStamp.json"));
        ...
        checkResult(
                mvcResult, "JSON parse error: Cannot deserialize value of type `java.time.OffsetDateTime`",
                OffsetDateTime.now(ZoneId.of("UTC"))
        );
    }
    ...
    public void itShouldRejectAnalyticsWithEmptyErrorName() throws Exception {
        ...
        checkResult(
                mvcResult, "[Field error in object 'analyticsRequest' on field 'errors[0].name': rejected value []",
                OffsetDateTime.now(ZoneId.of("UTC"))
        );
    }
    ...
    public void itShouldRejectAnalyticsWithoutErrorTimeStamp() throws Exception {
        ...
        checkResult(
                mvcResult,
                "[Field error in object 'analyticsRequest' on field 'errors[0].timestamp': rejected value [null]",
                OffsetDateTime.now(ZoneId.of("UTC"))
        );
    }
